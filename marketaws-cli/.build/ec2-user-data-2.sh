...
dnf install -y nginx nodejs
    ...
    echo 'd2luZG93LkFQUF9DT05GSUcgPSB7IEFQSV9VUkw6ICdodHRwczovLzl6Znl4dzAwOTguZXhlY3V0ZS1hcGkudXMtZWFzdC0xLmFtYXpvbmF3cy5jb20vcHJvZC9vcmRlcnMnLCBTRVJWRVJfTkFNRTogJ1NlcnZpZG9yIDInIH07' | base64 -d > /usr/share/nginx/html/config.js
