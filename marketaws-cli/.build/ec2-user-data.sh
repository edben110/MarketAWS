...
dnf install -y nginx nodejs
    ...
    aws s3 cp s3:///front/ /usr/share/nginx/html/ --recursive
    aws s3 cp s3:///app/ /home/ec2-user/app/ --recursive
    echo 'd2luZG93LkFQUF9DT05GSUcgPSB7IEFQSV9VUkw6ICcnLCBTRVJWRVJfTkFNRTogJ1NlcnZpZG9yIDAnIH07' | base64 -d > /usr/share/nginx/html/config.js
